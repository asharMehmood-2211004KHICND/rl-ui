...
const CreateStaff = () => {
  ...
  const url =
    "http://createstaffelasticbean-env.eba-aftp3we4.ap-south-1.elasticbeanstalk.com/creatstaff";
        ...
        <form className={styles.formCreateStaff} onSubmit={onSubmit}>
          ...
          <div className={styles.btnDiv}>
            <Button
              type="submit"
              text="Save"
              className={styles.saveButtonStaff}
            >
              Submit
            </Button>
            <Button
