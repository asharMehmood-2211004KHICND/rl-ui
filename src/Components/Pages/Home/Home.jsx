  ...
  useEffect(() => {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        setTotal((prev) => {
          return { ...prev, opening: data.length };
        });
    ...
    fetch(
      ...
      .then((data) => {
        ...
        setTotal((prev) => {
          return { ...prev, profile: data.length };
        });
    ...
    fetch(
      ...
      .then((data) => {
        ...
        setTotal((prev) => {
          return { ...prev, interviewsPending: data.length };
        });
    ...
    fetch(
      ...
      .then((data) => {
        ...
        setTotal((prev) => {
          return { ...prev, registeredUsers: data.length };
        });
  ...
  return (
    <div>
      <div className="hcards">
        <div className="card">
          <div className="cardupper">
            ...
            <p className="carddetails">
              <Link to="/job/all" className="link">
                Details...
              </Link>
            </p>
          </div>
        ...
        {authNagation(["1"], sessionStorage.getItem("user_roleid")) && (
          <div className="card">
            <div className="cardupper">
              <p className="cardtitle">Candidates</p>
              <h2 className="cardcount">{total.registeredUsers}</h2>
              <p className="carddetails">
                <Link to="/users/candidates/all" className="link">
                  Details...
                </Link>
              </p>
            </div>
        ...
        {authNagation(["1"], sessionStorage.getItem("user_roleid")) && (
          <div className="card">
            <div className="cardupper">
              ...
              <p className="carddetails">
                <Link to="/users/candidates/active" className="link">
                  Details...
                </Link>
              </p>
            </div>
        ...
        {authNagation(["1"], sessionStorage.getItem("user_roleid")) && (
          <div className="card">
            <div className="cardupper">
              ...
              <p className="carddetails">
                <Link to="/interview-schedule" className="link">
                  Details...
                </Link>
              </p>
            </div>
