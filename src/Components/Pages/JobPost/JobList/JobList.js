...
const JobsList = ({ jobsProp }) => {
  ...
  const handleSearch = (selectedKeys, confirm) => {
    ...
    setFilteredData(
      jobs.filter((job) =>
        job.title.toLowerCase().includes(selectedKeys[0].toLowerCase())
      )
    );
  };
  ...
  const handleDateChange = (dates, dateStrings) => {
    ...
    setFilteredData(
      jobs.filter((job) =>
        moment(job.expireDate).isBetween(
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "type",
      sorter: (a, b) =>
        a.departments.departmentName.localeCompare(
          b.departments.departmentName
        ),
    ...
    },
    {
      ...
      sorter: (a, b) =>
        moment(a.postDate).valueOf() - moment(b.postDate).valueOf(),
    ...
    },
    {
      ...
      sorter: (a, b) =>
        moment(a.closeDate).valueOf() - moment(b.closeDate).valueOf(),
      filterDropdown: ({
        setSelectedKeys,
        selectedKeys,
        confirm,
  ...
  return (
    <>
      <div className={Styled.JobsTableHeading}>
        <h1> Jobs List</h1>
        {authNagation(["1", "2"], sessionStorage.getItem("user_roleid")) && (
          <Link to="/createJob">
            <IconButton>
